...
public class MODIFICARDSILO extends AppCompatActivity implements ZXingScannerView.ResultHandler {
Button btnC1;
    private ZXingScannerView escaner1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_modificarsilo);
        btnC1= (Button) findViewById(R.id.GuardarNuevoSilo);
        btnC1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent btnC1 =new Intent(MODIFICARDSILO.this,Main2Activity.class);
                startActivity(btnC1);
            }
        });
    }
